...
| 📷 **Scan Slip** | อ่านสลิปธนาคารด้วย AI (Groq · Llama 4 Scout Vision) — กรอกข้อมูลอัตโนมัติ |
...
const GROQ_API_KEY    = '...';  // console.groq.com/keys (อ่านสลิป + วิเคราะห์หุ้น)
```

- **Finnhub** ฟรี 60 calls/นาที — [finnhub.io](https://finnhub.io)
- **Groq** ฟรี เร็วมาก (LPU) — [console.groq.com/keys](https://console.groq.com/keys) · text: `llama-3.3-70b-versatile` · vision: `llama-4-scout`
...
Charts      : Chart.js 4.4
AI          : Groq (Llama 4 Scout vision · Llama 3.3 70B text)
